...
var filter = m => m.author.id === message.author.id;
      ...
      message.channel.send(`:eight_pointed_black_star:| **Çekilişin yapılacağı kanalın adını yaz\n kanalı kopyala'ya bas\nKanalın adını kopyala\nHiçbirşey yapmadan yapıştır gitsin**`).then(msg => {
                ...
                try {
                  ...
                  message.guild.channels.find("name" , room).send('' , {embed: giveEmbed}).then(m => {
                     ...
                     setTimeout(() => {
                       ...
                       .setTitle(title)
                       .setColor('RANDOM')
            .setFooter("(REC-ND çekiliş sistemi)")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.RichEmbed()
                        .setColor('RANDOM')
                        .setDescription("Ödülünü Moderatörleri Etiketleyerek Alabilirsin!").setFooter("(REC-ND Çekiliş sistemi)")
