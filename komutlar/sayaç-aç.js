...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.reply(`Bu komutu kullanabilmek için **Yönetici** iznine sahip olmalısın!`);
        if(!args[0]) {
                const embed = new Discord.RichEmbed()
                        .setDescription(`Ayarlamam İçin Bir Sayı Seçmeli ve Kanal Etiketlemelisin. \nÖrnek Kullanım : .sayaç-ayarla 1000 #kanal \n**Sayaç Kapatmak istiyorsan .sayaç-sıfırla**`)
                        .setColor("RANDOM")
                        .setTimestamp()
  ...
  profil[message.guild.id].kanal = mentionedChannel.id
        ...
        const embed = new Discord.RichEmbed()
                ...
                .setFooter('REC-ND, iyi eğlenceler diler!', client.user.avatarURL)
                .setColor("RANDOM")
                .setTimestamp()
        message.channel.send({embed})
}
